...
for(var i=0; i<docs.length; i++) {
    ...
    fs.appendFileSync('mongo_pins.sql', "db.Maps_Pins.insert(\n");
    fs.appendFileSync('mongo_pins.sql', JSON.stringify(doc));
    fs.appendFileSync('mongo_pins.sql', ");\n");
}
