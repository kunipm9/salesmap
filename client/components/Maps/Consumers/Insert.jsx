 ...
 * @returns
 */
export const Maps_Consumers_Insert_ComponentInfo = mode => {
 ...
 *
 * @export
 * @class Maps_Consumers_Insert
 * @extends {Insert}
 */
export class Maps_Consumers_Insert extends Insert {
  "use strict";

  /**
   *Creates an instance of Maps_Consumers_Insert.
   * @param {*} props
   * @memberof Maps_Consumers_Insert
   */
  constructor(props) {
    super(props);
    /// Custom - Role - check permission
    this.ComponentInfo = Maps_Consumers_Insert_ComponentInfo;
    /// Custom - Role - check permission --
