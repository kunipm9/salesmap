 ...
 * @returns
 */
export const Maps_Pins_View_Update_ComponentInfo = mode => {
 ...
 *
 * @export
 * @class Maps_Pins_View_Update
 * @extends {Update}
 */
export class Maps_Pins_View_Update extends Update {
  "use strict";

  /**
   *Creates an instance of Maps_Pins_View_Update.
   * @param {*} props
   * @memberof Maps_Pins_View_Update
   */
  constructor(props) {
    super(props);

    /// Custom - Role - check permission
    this.ComponentInfo = Maps_Pins_View_Update_ComponentInfo;
    /// Custom - Role - check permission --
