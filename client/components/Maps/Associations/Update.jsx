 ...
 * @returns
 */
export const Maps_Associations_Update_ComponentInfo = mode => {
  ...
  return { title: "Maps/Associations/Update", path: "/Maps/Associations/Update" };
};
/// Custom - Role - check permission --
 ...
 *
 * @export
 * @class Maps_Associations_Update
 * @extends {Update}
 */
export class Maps_Associations_Update extends Update {
  "use strict";

  /**
   *Creates an instance of Maps_Associations_Update.
   * @param {*} props
   * @memberof Maps_Associations_Update
   */
  constructor(props) {
    super(props);

    /// Custom - Role - check permission
    this.ComponentInfo = Maps_Associations_Update_ComponentInfo;
    /// Custom - Role - check permission --
