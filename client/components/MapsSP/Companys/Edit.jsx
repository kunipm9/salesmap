 ...
 * @returns
 */
export const MapsSP_Companys_Update_ComponentInfo = mode => {
  ...
  return { title: "MapsSP/Companys/Update", path: "/MapsSP/Companys/Update" };
};
/// Custom - Role - check permission --
...
export class Edit extends Update {
  ...
  constructor(props) {
    ...
    /// Custom - Role - check permission
    this.ComponentInfo = MapsSP_Companys_Update_ComponentInfo;
    /// Custom - Role - check permission --
