...
export function displayAssociation(
  doc,
  idx,
  history,
  updatePath,
...
export const getAssociationName = _id => {
  const association = Maps_Associations_Collection.findOne({ _id: _id });
  if (association) {
...
export const getAssociationDetail = _id => {
  const doc = Maps_Associations_Collection.findOne({ _id: _id });
  if (doc) {
    return (
      <span>
        {
