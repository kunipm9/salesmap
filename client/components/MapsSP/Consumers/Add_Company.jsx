 ...
 * @extends {Update}
 */
export class Add_Company extends Add_Base {
  "use strict";

  /**
   *Creates an instance of Add_Company.
   * @param {*} props
   * @memberof Add_Company
   */
  constructor(props) {
    console.log(new Date().getTime(), "Add_Company constructor");
    super(props);
   ...
   */
  submit(doc) {
    console.log(new Date().getTime(), "Add_Company submit");
    /// Sys - AutoForm - update
   ...
   */
  addCompany = () => {
    console.log(new Date().getTime(), "Add_Company addCompany");
   ...
   */
  render() {
    console.log(new Date().getTime(), "Add_Company render");
