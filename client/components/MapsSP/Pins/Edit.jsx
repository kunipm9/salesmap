...
export class Edit extends Update {
  ...
  constructor(props) {
    super(props);
console.log(new Date().getTime(), "Pin Edit constructor");
   ...
   */
  componentDidMount() {
console.log(new Date().getTime(), "Pin Edit componentDidMount");
    /// Custom - Role - check permission
    this.securityCheck();
    /// Custom - Role - check permission --
  }
   ...
   */
  securityCheck() {
console.log(new Date().getTime(), "Pin Edit securityCheck");
   ...
   */
  submit(doc) {
console.log(new Date().getTime(), "Pin Edit submit");
    /// Sys - AutoForm - update
   ...
   */
  render() {
console.log(new Date().getTime(), "Pin Edit render");
      ...
      <React.Fragment>
        ...
        >
          ...
          <Segment
            ...
            style={{ height: this.window_innerHeight - 68 + "px" }}
          >
