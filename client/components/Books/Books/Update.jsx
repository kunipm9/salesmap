 ...
 * @returns
 */
export const Books_Books_Update_ComponentInfo = (mode) => {
 ...
 *
 * @export
 * @class Books_Books_Update
 * @extends {Update}
 */
export class Books_Books_Update extends Update {
  ...
  constructor(props) {
    ...
    /// Custom - Role - check permission
    this.ComponentInfo = Books_Books_Update_ComponentInfo;
    /// Custom - Role - check permission --
      ...
      <React.Fragment>
        ...
        <AutoForm
          ...
          <MDBBtn
            ...
            >Read Excel</MDBBtn>
          <ErrorsField />
          {this.UpdateFormButtons(['Books.Books', 'update'], ['Books.Books', 'delete'])}
        </AutoForm>
