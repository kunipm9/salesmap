...
const renderSelect = props => {
  ...
  const children = (
      <Select
        styles={customStyles}
        className={classnames(props.inputClassName, "form-control", "mui-SelectField-custom", {
  ...
  return wrapField(
    {...props, disabled: props.disabled, component: 'fieldset'},
    props.label && (
      <InputLabel shrink={true} style={labelStyle} className={labelClass} htmlFor={props.name}>
        {props.label}
      </InputLabel>
    ),
    children
...
const _Select = ({checkboxes, ...props}) =>  {
  const divStyle = {
...
export default connectField(_Select);
